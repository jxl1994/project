        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <form role="form" method="post" action="<?php echo U('Admin/QuanXian/insert');?>" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label>规则名称</label>
                                    <input type='text' name="title" placeholder="请输入规则名" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>权限标识</label>
                                    <input type="text" name="name" placeholder="请输入标识" class="form-control">
                                </div>
