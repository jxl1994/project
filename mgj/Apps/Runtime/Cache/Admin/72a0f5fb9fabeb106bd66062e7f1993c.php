                            ...
                            <form role="form" method="post" action="<?php echo U('Admin/User/update');?>" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="level" class="form-control">
                                        <option value="游客" <?php if($info['level'] == 0): ?>selected<?php endif; ?>>游客</option>
                                        <option value="会员" <?php if($info['level'] == 1): ?>selected<?php endif; ?>>会员</option>
                                        <option value="管理员" <?php if($info['level'] == 2): ?>selected<?php endif; ?>>管理员</option>
                                        <option value="超级管理员" <?php if($info['level'] == 3): ?>selected<?php endif; ?>>超级管理员</option>
                                    </select>
                                </div>
