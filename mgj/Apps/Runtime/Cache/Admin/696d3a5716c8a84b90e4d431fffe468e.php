...
<body>
    ...
    <h1 class="page-header">组权限的添加</h1>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <form role="form" method="post" action="<?php echo U('Admin/QuanXian/Group_insert');?>" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label>添加组的名称</label>
                                    <input type='text' name="title" placeholder="请输入组名" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>权限规则</label><br>
                                    <?php if(is_array($rules)): foreach($rules as $key=>$vo): ?><input type="checkbox" name="rules[]" value="<?php echo ($vo['id']); ?>">&nbsp;<?php echo ($vo["title"]); ?>&nbsp;<?php endforeach; endif; ?>
                                </div>
