                ...
                <div class="panel-body">
                    <div class="dataTable_wrapper">
                        <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                        	<div class="row">
                                <form action="<?php echo U('Admin/Adver/index');?>" method="get">
                                    <div class="col-sm-6">
                 ...
                 <table id="dataTables-example" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dataTables-example_info">
                    <thead>
                        <tr role="row">
                           ...
                           <th class="sorting_asc" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 60px;" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">广告信息</th>
                           <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 60px;" aria-label="Platform(s): activate to sort column ascending">广告域名</th>
                   ...
                   <tbody>
                    ...
                    <?php if(is_array($res)): foreach($res as $key=>$vo): ?><tr class="gradeA odd" role="row">
                            ...
                            <td>
                                <a href="<?php echo U('Admin/Adver/delete',array('id'=>$vo['id']));?>"><button type="button" class="btn btn-danger">删除</button></a>
                                <a href="<?php echo U('Admin/Adver/edit',array('id'=>$vo['id']));?>"><button type="button" class="btn btn-primary">修改</button></a></td>
                            </td>
