                 ...
                 <table id="dataTables-example" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dataTables-example_info">
                   ...
                   <tbody>
                    ...
                    <?php if(is_array($Goods)): foreach($Goods as $key=>$vo): ?><tr class="gradeA odd" role="row">
                           ...
                           <td class="center"><img class='pic' src="/mgj/Public<?php echo ($vo["pic"]); ?>" width="50px">
                              <div style="width:77px;height:25px;border:0px solid blue;padding-top:2px;">
                                <?php
 $sql = 'select * from goods_image where ggid='.$vo['id']; $result=mysql_query($sql); while ($row=mysql_fetch_assoc($result)) { echo '<div style="width:25px;height:25px;border:0px solid blue;float:left">'; echo '<img width="25px"  src="/mgj/Public'.$row['minpic'].'">'; echo '</div>'; } ?>
                              </div>
                           </td>
...
<!-- /.col-lg-12 -->
   ...
   $(function(){
    ...
    $('.pic').click(function(){
     ...
     var url="http://localhost/mgj/index.php/Admin/Goods/smailpic/ggid/";
     location.href= url+v;
