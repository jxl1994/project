...
<body>
    ...
    <h1 class="page-header">配送方式修改</h1>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <form role="form" method="post" action="<?php echo U('Admin/Post/update');?>" enctype="multipart/form-data">
                                <input type="hidden" name="id" value="<?php echo ($sends['id']); ?>">
                                <div class="form-group">
                                    <label>订单号</label>
                                    <input value="<?php echo ($sends['orderid']); ?>" id="disabledInput" disabled name="username" placeholder="请输入用户名" class="form-control">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="way" class="form-control">
                                        ...
                                        <option value="0" <?php if($sends['way'] == 0): ?>selected<?php endif; ?>>请选择</option>
                                        <option value="顺风" <?php if($sends['way'] == 顺风): ?>selected<?php endif; ?>>顺风</option>
                                        <option value="申通" <?php if($sends['way'] == 申通): ?>selected<?php endif; ?>>申通</option>
                                        <option value="EMS" <?php if($sends['way'] == EMS): ?>selected<?php endif; ?>>EMS</option>
                                    </select>
                                </div>
