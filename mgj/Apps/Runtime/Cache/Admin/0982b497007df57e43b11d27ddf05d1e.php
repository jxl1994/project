                ...
                <div class="panel-body">
                    <div class="dataTable_wrapper">
                        <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                        	<div class="row">
                                <form action="<?php echo U('Admin/Activity/index');?>" method="get">
                                    <div class="col-sm-6">
 ...
 $arr=array('开启','关闭'); ?>
                    ...
                    <?php if(is_array($res)): foreach($res as $key=>$vo): ?><tr class="gradeA odd" role="row">
                            ...
                            <td>
                                ...
                                <a href="<?php echo U('Admin/Activity/edit',array('id'=>$vo['id']));?>"><button type="button" class="btn btn-primary">修改</button></a></td>
                            </td>
