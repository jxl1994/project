...
<body>
    ...
    <h1 class="page-header">添加配送方式</h1>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <form role="form" method="post" action="<?php echo U('Admin/Post/insert');?>" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label>订单号</label>
                                    <input name="orderid" placeholder="请输入订单号" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>配送方式</label>
