        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <form role="form" method="post" action="<?php echo U('Admin/QuanXian/Group_update');?>" enctype="multipart/form-data">
                                <input type="hidden" name="id" value="<?php echo ($info['id']); ?>">
                                <div class="form-group">
                                    <label>组名</label>
                                    <input type='text' name="title" value="<?php echo ($info['title']); ?>" placeholder="请输入组名" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>组权限规则</label>
                                    <?php if(is_array($rules)): foreach($rules as $key=>$vo): ?><input type="checkbox" name="rules[]" value="<?php echo ($vo['id']); ?>" 
                                        <?php
 $arr=explode(",",$info['rules']); ?>
                                        <?php if(in_array($vo['id'],$arr)): ?>checked<?php endif; ?>>&nbsp;<?php echo ($vo["title"]); ?>&nbsp;<?php endforeach; endif; ?>
                                </div>
