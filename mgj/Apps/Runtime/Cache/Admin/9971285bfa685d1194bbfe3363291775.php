...
<body>
                ...
                <div class="panel-body">
                    <div class="dataTable_wrapper">
                        <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                        	<div class="row">
                                <form action="<?php echo U('Admin/User/trach');?>" method="get">
                                    <div class="col-sm-6">
 ...
 $time=time(); $a=date('Y-m-d H:i:s'); ?>
                            ...
                            <td class="center">
                                <a href="<?php echo U('Admin/User/delete',array('id'=>$vo['id']));?>"><button type="button" class="btn btn-danger">删除</button></a>
                                <a href="<?php echo U('Admin/User/hf',array('id'=>$vo['id']));?>"><button type="button" class="btn btn-primary">恢复</button></a>
                            </td>
