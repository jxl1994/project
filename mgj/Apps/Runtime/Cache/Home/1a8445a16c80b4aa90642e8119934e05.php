	...
	<div id="zc">
		...
		<div class="zc_main">
			...
			<div class="form">
				...
				<div class="form_main">
					<div class="main">
						<form action="<?php echo U('index.php/Home/User/dl');?>" method="post">
							<input type="text" name="username" class="username" placeholder="用户名">
							<input type="password" name="password" class="password" placeholder="密码">
							<button class="tj">登录</button>
							
							<div class="login"><a href="<?php echo U('index.php/Home/User/zhuce');?>">新用户注册</a></div>
						</form>
