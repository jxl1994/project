                ...
                <div class="panel-body">
                    <div class="dataTable_wrapper">
                        <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                          <div class="row">
                            <form action="<?php echo U('Home/Myorder/details');?>" method="post">
                                <div><center><h3>订单详情表</h3></center></div>
                                <div style="float:right;margin-right:30px;"><a href="<?php echo U('Home/Myorder/detail');?>">返回订单列表</a></div>           
        					</div>
                 ...
                 <table id="dataTables-example" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dataTables-example_info">
                    <thead>
                        <tr role="row" align="center">
                           <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width:37px;" aria-label="Browser: activate to sort column ascending">订单id</th>
                           <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width:37px;" aria-label="Browser: activate to sort column ascending">商品id</th>
                          
                           <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 57px;" aria-label="Engine version: activate to sort column ascending">数量</th>
 <!--                           <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" style="width: 50px;" aria-label="CSS grade: activate to sort column ascending">地址</th>
                   ...
                   <tbody>
                    <!-- 这是商品列表的遍历 -->
                    <?php if(is_array($detail)): foreach($detail as $key=>$row): ?><tr>
                            <td class="sid"><?php echo ($row["orderid"]); ?></td>
                            <td class="sid"><?php echo ($row["goodsid"]); ?></td>
                            <td class="sid"><?php echo ($row["num"]); ?></td>
                           <!--  <td class="sid"><?php echo ($row["address"]); ?></td> 
