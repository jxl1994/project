 ...
 if(!$_SESSION['uid']){ ?>
	...
	<div id="list">
		...
		<div class="l">
			<?php  if( $status!= '1' ){ ?>
				<div class="time" >
					<div id='jz' style='display:none'><?php echo ($jz); ?></div>
		...
		<?php if(is_array($result)): foreach($result as $key=>$vo): ?><div class="list_g1">
				<dl>
					<dt><a href="<?php echo U('Home/Detail/index',array('id'=>$vo['id'],'zk'=>$zk,'zhekou'=>$vo['zhekou']));?>"><img src="/Public/<?php echo ($vo["pic"]); ?>" width="179" height="190" alt=""></a></dt>
