...
<link rel="stylesheet" href="/Public/Home/css/shoucang.css">
<div class="sc_head">
	<div class="sc_h1">
		<div class="sc_div1">我的收藏</div>
		<div>我的动态</div>
		<div>我的关注</div>
		<div class="sc_div2">我的粉丝</div>
	</div>
</div>
<div class="sc_main">
	<div class="sc_good">
	<?php if(is_array($sc)): foreach($sc as $key=>$vo): ?><div class="sc_good1">
