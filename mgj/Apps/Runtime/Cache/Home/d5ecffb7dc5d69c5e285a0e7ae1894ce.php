...
<body>
 ...
 if(!$_SESSION['uid']){ ?>
	...
	<link rel="stylesheet" href="/Public/Home/css/kongcart.css">
	<div id="quan">
		<div class="tou">
		...
		<div class="spbiao">
			<div class="cart_goods">
				<div class="kcart_img">
					<img src="/Public/Home/images/kcart.png" alt="">
				</div>
				<div class="kcart_ts">
					<span>您的购物车还是空的，赶快去挑选商品吧！</span>
					<a href="<?php echo U('Home/Index/index');?>">去购物</a>
				</div>
